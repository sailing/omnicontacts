  ...
  module Importer
    class Gmail < Middleware::OAuth2
      ...
      def parse_contacts contacts_as_xml, access_token, token_type
        ...
        # contacts << :token_type => token_type
        xml.elements.each('//entry') do |entry|
          ...
          if gd_email
            ...
            contact[:avatar_url] = gd_avatar ? gd_avatar.attribute('href').to_s : "http://www.postnuclear.net/wordpress/wp-content/uploads/2010/04/250px-The_Earth_seen_from_Apollo_17-64x64.jpg"
